...
from utils import (
    ...
    update_account_username, get_setting, list_accounts, create_account,
    delete_account, create_pending_transaction_with_due_date, get_all_transactions,
    get_top_debtors, update_setting, reset_all_data, get_customer_list,
    validate_amount, calculate_interest, get_interest_rate, get_transaction_statistics,
    delete_transaction, delete_alert, check_due_dates, get_upcoming_due_dates, 
    get_overdue_transactions, verify_transaction_exists  # ← ADD THIS
)
...
def show_owner_overview():
    ...
    # Quick stats in organized containers
    ...
    # Calculate total outstanding and interest
    total_outstanding = 0
    total_interest = 0
    ...
    with st.container():
        ...
        with col1:
            ...
            <div class="owner-metric-box">
                <div class="owner-metric-label">Total Customers</div>
                <div class="owner-metric-value" style="color: var(--accent-blue) !important;">{total_customers}</div>
                <div style="font-size: 0.8rem; color: var(--text-primary); opacity: 0.7;">Active customer accounts</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown(f"""
            <div class="owner-metric-box">
                <div class="owner-metric-label">Total Transactions</div>
                <div class="owner-metric-value" style="color: var(--navy-light) !important;">{total_transactions}</div>
                <div style="font-size: 0.8rem; color: var(--text-primary); opacity: 0.7;">All transactions</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col3:
            ...
            <div class="owner-metric-box">
                ...
                <div style="font-size: 0.8rem; color: var(--text-primary); opacity: 0.8;">Total amount due</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col4:
            ...
            <div class="owner-metric-box">
                ...
                <div style="font-size: 0.8rem; color: var(--text-primary); opacity: 0.7;">Interest earned</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col5:
            ...
            <div class="owner-metric-box">
                ...
                <div style="font-size: 0.8rem; color: var(--text-primary); opacity: 0.7;">Upcoming in 7 days</div>
            </div>
            """, unsafe_allow_html=True)
    ...
    with st.container():
                ...
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0.5rem 0 0 0; color: var(--text-primary); opacity: 0.8;">
                            There are {len(overdue_transactions)} utang(s) that are overdue!
                        </p>
                    </div>
        ...
        if upcoming_due_dates:
            ...
            if critical_due > 0:
                ...
                <div class="due-date-alert due-date-warning">
                    <div style="display: flex; align-items: center; justify-content: space-between;">
                        <div style="flex: 1;">
                            <h4 style="margin: 0; color: var(--text-primary);">⏰ Critical Due Dates</h4>
                            <p style="margin: 0.5rem 0 0 0; color: var(--text-primary); opacity: 0.8;">
                                {critical_due} utang(s) due within 3 days!
                            </p>
                        </div>
        ...
        if pending_count > 0:
            ...
            <div class="due-date-alert due-date-info">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div style="flex: 1;">
                        <h4 style="margin: 0; color: var(--text-primary);">📋 Pending Transactions</h4>
                        <p style="margin: 0.5rem 0 0 0; color: var(--text-primary); opacity: 0.8;">
                            There are {pending_count} transactions waiting for OTP confirmation
                        </p>
                    </div>
                    <div style="font-size: 2rem;">📋</div>
                </div>
                ...
                with st.spinner("🔍 Checking due dates and sending reminders..."):
                    try:
                        ...
                        if success:
                            ...
                            upcoming_count = len(get_upcoming_due_dates(7))
                            
                            if overdue_count > 0:
                                st.error(f"🚨 {overdue_count} overdue utang(s) found")
                            if upcoming_count > 0:
                                st.info(f"📅 {upcoming_count} upcoming due date(s) in the next 7 days")
                            if overdue_count == 0 and upcoming_count == 0:
                                st.success("🎉 No due date issues found! All utang are either paid or not due soon.")
    ...
    with st.container():
        ...
        if top_debtors:
            ...
            <div class="empty-state">
                ...
                <p>All customers have paid their balances</p>
            </div>
            """, unsafe_allow_html=True)
...
def show_account_management():
    """Show account management in organized containers"""
    ...
    with st.container():
        ...
        with st.form("create_account_form", clear_on_submit=True):
            ...
            # In the show_account_management() function, update the form section:
            ...
            if submitted:
                ...
                success, message = create_account(username, password, role, personal_info)
                if success:
                    st.success(message)
                    st.rerun()
                else:
    ...
    # Existing accounts in containers
...
def show_add_utang():
    """Show add utang form with organized containers"""
    ...
    # Initialize session state for this transaction - FIXED VERSION
    ...
    if st.session_state.current_transaction['step'] == 1:
        with st.container():
            with st.form("add_utang_form_step1", clear_on_submit=False):  # Changed to not clear on submit
                ...
                if submitted:
                    ...
                    if transaction:
                        ...
                        st.session_state.current_transaction = {
                            ...
                            'transaction_id': transaction["id"]  # This is the critical part
                        }
                        
                        print(f"✅ Transaction created and stored in session state:")
        ...
        # Step 2: Confirm with OTP - FIXED VERSION
        ...
        with st.container():
            ...
            # Rest of your OTP confirmation code continues...
    ...
    with st.container():
        ...
        upcoming_due_dates = get_upcoming_due_dates()
        overdue_transactions = get_overdue_transactions()
        
        # Overdue Section
        if overdue_transactions:
            st.error(f"🚨 **{len(overdue_transactions)} OVERDUE UTANG(S)**")
        ...
        if upcoming_due_dates:
            ...
            if urgent_due:
                st.warning(f"🔴 **{len(urgent_due)} URGENT** - Due within 7 days")
                for due_info in urgent_due[:3]:
                    display_due_date_item(due_info, "urgent")
            
            if approaching_due:
                st.info(f"🟠 **{len(approaching_due)} APPROACHING** - Due in 8-30 days")
                for due_info in approaching_due[:2]:
                    display_due_date_item(due_info, "approaching")
            
            if comfortable_due:
                st.success(f"🟢 **{len(comfortable_due)} COMFORTABLE** - Due in 31+ days")
...
def show_record_payment():
    """Show record payment form with OTP workflow"""
    st.markdown("## Record Payment")
    
    # Initialize payment_amount if not set
    if 'payment_amount' not in st.session_state:
        st.session_state.payment_amount = 1000.0  # Default value
            ...
            if selected_customer:
                ...
                with col1:
                    if st.button("Full Payment", use_container_width=True, 
                        ...
                        st.session_state.payment_amount = float(outstanding_balance)  # Ensure it's float
                ...
                if payment_type == "Full Payment":
                    ...
                    if st.button("Send OTP to Customer", use_container_width=True, type="primary", key="send_otp_full"):
                        ...
                        transaction, message = create_pending_transaction_with_due_date(
                            ...
                            payment_amount_float,  # Use validated float
...
def show_pending_confirmations():
        ...
        <div class="message-container">
            <div class="message-content">
                <div class="empty-state">
                    ...
                    <p>All transactions have been confirmed</p>
                </div>
            </div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with st.container():
        ...
        st.info("The following transactions are waiting for OTP confirmation from customers.")
...
def show_reports():
    """Show reports with due date analytics"""
    st.markdown("## Reports & Analytics")
    
    # Due Date Analytics Section
    with st.container():
        st.markdown("""
        <div class="message-container">
            <div class="message-header">
                <span>📅 Due Date Analytics</span>
            </div>
            <div class="message-content">
        """, unsafe_allow_html=True)
        
        upcoming_due_dates = get_upcoming_due_dates(30)
        overdue_transactions = get_overdue_transactions()
        ...
        if stats:
            ...
            with col1:
                ...
                <div style="background: var(--bg-secondary); padding: 1rem; border-radius: 8px; border-left: 4px solid var(--accent-teal);">
                    <div style="font-weight: bold; color: var(--text-primary);">Transaction Statistics</div>
            ...
            with col2:
                ...
                <div style="background: var(--bg-secondary); padding: 1rem; border-radius: 8px; border-left: 4px solid var(--accent-blue);">
                    <div style="font-weight: bold; color: var(--text-primary);">Customer Statistics</div>
                    <div style="display: flex; justify-content: space-between; margin-top: 0.5rem;">
